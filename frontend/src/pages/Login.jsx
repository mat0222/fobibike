...
import { FiLock, FiUser, FiAlertCircle, FiArrowRight } from 'react-icons/fi';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      {/* Panel izquierdo — imagen (desktop) */}
      ...
      <div className="flex-1 flex items-center justify-center bg-[#f8fafc] px-6 py-12 sm:px-12 lg:px-16">
        <div className="w-full max-w-[420px]">
          <div className="lg:hidden mb-8 text-center">
            <p className="text-slate-400 text-sm">Sistema de administracion</p>
          </div>
