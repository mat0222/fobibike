          ...
          <div className="relative z-10 flex flex-col justify-between p-10 xl:p-14 w-full">
            ...
            <div>
              ...
              <p className="text-blue-100/70 mt-4 max-w-sm text-sm leading-relaxed">
                Inventario, ingresos, facturación, reparaciones y asistente IA — sin datos reales del negocio.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-[420px]">
            <div className="mb-8">
              ...
              <p className="text-slate-500 mt-2 text-sm leading-relaxed">
                Recorré el diseño del sistema, incluidos facturación y el taller de reparaciones. El inventario y las ventas reales no se muestran.
              </p>
            </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[55%] relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-10 xl:p-14 w-full">
          ...
          <div>
            ...
            <p className="text-blue-100/70 mt-4 max-w-sm text-sm leading-relaxed">
              Administrá inventario, ventas, facturación, reparaciones e ingresos desde un solo lugar.
            </p>
          </div>
        </div>
      </div>
