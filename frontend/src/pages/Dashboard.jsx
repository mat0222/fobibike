    ...
    <Layout sidebar={sidebar}>
      <div className="space-y-6">
        <PageHeader
          ...
          description={
            IS_DEMO
              ? 'Vista estructural — los productos reales del local no se exhiben.'
              : loading
                ? 'Cargando productos...'
            ...
            !IS_DEMO ? (
              <>
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 bg-[#2563eb] hover:bg-[#1d4ed8] text-white font-semibold rounded-xl transition-colors shadow-sm"
                >
                  <FiPlus />
                  Agregar producto
                </button>
                <div className="flex items-center gap-2 px-4 py-2.5 bg-white rounded-xl border border-slate-200 shadow-sm">
                  <div className="p-1.5 bg-blue-50 rounded-lg">
                    <FiPackage className="text-[#1d4ed8]" />
                  </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-slate-50 text-slate-500">
                  <th className="text-left px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider">Código</th>
                  <th className="text-left px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider">Producto</th>
                  <th className="text-left px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider hidden md:table-cell">Categoría</th>
                  <th className="text-left px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider hidden lg:table-cell">Tipo</th>
                  <th className="text-left px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider hidden xl:table-cell">Proveedor</th>
                  <th className="text-right px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider">Contado</th>
                  <th className="text-right px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider hidden sm:table-cell">Plazo</th>
                  <th className="text-center px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider">Stock</th>
                  <th className="text-center px-4 py-3.5 font-semibold text-[11px] uppercase tracking-wider">Acciones</th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
